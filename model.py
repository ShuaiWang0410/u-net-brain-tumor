...
def u_net(x, is_train=False, reuse=False, n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        # up4 = DeConv2d(conv5, 512, (3, 3), (nx/8, ny/8), 'valid', strides=(2, 2), name='deconv4')
        up4 = DeConv2d(conv5, 512, (3, 3), (2, 2), 'same', name='deconv4')
        ...
        # up3 = DeConv2d(conv4, 256, (3, 3), (nx/4, ny/4), 'valid', strides=(2, 2), name='deconv3')
        up3 = DeConv2d(conv4, 256, (3, 3), (2, 2), 'same', name='deconv4')
        ...
        # up2 = DeConv2d(conv3, 128, (3, 3), (nx/2, ny/2), 'valid', strides=(2, 2), name='deconv2')
        up2 = DeConv2d(conv3, 128, (3, 3), (2, 2), 'same', name='deconv4')
        ...
        # up1 = DeConv2d(conv2, 64, (3, 3), (nx/1, ny/1), 'valid', strides=(2, 2), name='deconv1')
        up1 = DeConv2d(conv2, 64, (3, 3), (2, 2), 'same', name='deconv4')
